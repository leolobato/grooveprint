...
def _get_db_path() -> str:
    return os.environ.get("GROOVEPRINT_DB_PATH", str(Path(__file__).parent.parent / "data" / "fingerprints.db"))
...
async def lifespan(app: FastAPI):
    ...
    print(f"Grooveprint Server starting (commit: {VERSION})")
...
app = FastAPI(title="Grooveprint Server", lifespan=lifespan)
