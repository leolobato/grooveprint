...
import cc.grooveprint.android.Config
import cc.grooveprint.android.control.ControlServer
...
class ControlService : Service() {
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            ...
            description = "Grooveprint control server is running"
        }
    ...
    companion object {
        const val CHANNEL_ID = "grooveprint_control"
