package cc.grooveprint.android.service
...
import cc.grooveprint.android.audio.AudioCaptureManager
import cc.grooveprint.android.matching.LogEntry
import cc.grooveprint.android.matching.MatchClient
import cc.grooveprint.android.matching.MatchState
...
class ListeningService : Service() {
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            CHANNEL_ID,
            "Grooveprint Listening",
            NotificationManager.IMPORTANCE_LOW
        ).apply {
            description = "Shows when Grooveprint is actively listening"
        }
    ...
    companion object {
        ...
        const val CHANNEL_ID = "grooveprint_listening"
